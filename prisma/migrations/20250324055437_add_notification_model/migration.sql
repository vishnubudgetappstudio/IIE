/*
  ...
  - You are about to drop the `NotificationModel` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropForeignKey
ALTER TABLE `NotificationModel` DROP FOREIGN KEY `NotificationModel_senderId_fkey`;

-- DropForeignKey
ALTER TABLE `NotificationRecipient` DROP FOREIGN KEY `NotificationRecipient_notificationId_fkey`;

-- DropTable
DROP TABLE `NotificationModel`;
