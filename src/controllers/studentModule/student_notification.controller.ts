...
import { student_notificationListService } from "../../services/studentModule/student_notification.service";

export const student_NotificationList = async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
        ...
        // Fetch notifications
        const notifications = await student_notificationListService({
            student_id: userId,
            role: role,
            page: page,
            pageSize: limit,
